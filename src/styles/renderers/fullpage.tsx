...
export const fullpageRenderer: Renderer = {
  h1: (children, fontTitle) => (
    <div className="xhs-h1 xhs-h1-fullpage" data-xhs-block>
      <h1 style={{ fontFamily: fontTitle, marginBottom: 0 }}>{children}</h1>
    </div>
  ),
  h2: (children) => <div className="xhs-h2 xhs-h2-fullpage" data-xhs-block><span>{children}</span></div>,
  ...
  p: (children, fontBody) => (
    <div className="xhs-card xhs-card-fullpage" data-xhs-block>
      <p className="xhs-paragraph" style={{ fontFamily: fontBody }}>{children}</p>
    </div>
  ),
  blockquote: (children) => (
    <blockquote className="xhs-blockquote xhs-blockquote-fullpage" data-xhs-block>{children}</blockquote>
  ),
