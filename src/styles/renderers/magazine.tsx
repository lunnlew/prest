...
export const magazineRenderer: Renderer = {
  h1: (children, fontTitle) => (
    <div className="xhs-h1 xhs-h1-magazine" data-xhs-block>
      <h1 style={{ fontFamily: fontTitle, marginBottom: 0 }}>{children}</h1>
    </div>
  ),
  h2: (children) => <div className="xhs-h2 xhs-h2-magazine" data-xhs-block><span>{children}</span></div>,
  ...
  p: (children, fontBody) => (
    <div className="xhs-paragraph xhs-paragraph-magazine" data-xhs-block>
      <p style={{ fontFamily: fontBody, margin: 0 }}>{children}</p>
    </div>
  ),
  blockquote: (children) => (
    <blockquote className="xhs-blockquote xhs-blockquote-magazine" data-xhs-block>{children}</blockquote>
  ),
