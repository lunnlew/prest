...
| v0.11.0 | 2026-04-07 | 键盘导航/快捷键提示：快捷键对话框（格式化/标题/AI/导航）、F1 全局快捷键、设置面板入口 |
| v0.11.1 | 2026-04-08 | 配置导入/导出：设置面板添加导入/导出按钮，支持 JSON 格式配置文件 |
...
| 2.10 | A11Y-001 键盘导航/快捷键提示 | ✅ | 2h | `KeyboardShortcutsDialog.tsx`, `SettingsPanel.tsx` — 快捷键对话框、F1 全局快捷键、Tab/Enter/Esc 导航支持 |
